                ...
                <div class="px-4 sm:px-6 lg:px-8">
                    <div class="sm:flex sm:items-center sm:justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-sm text-gray-700">A list of all Skills.</p>
                        </div>
                        <Link 
                                    ...
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-200 bg-white">
                                            <tr v-for="skill in skills.data" :key="skill.id">
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-900">{{ skill.id }}</td>
                                                <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-900">{{ skill.name }}</td>
